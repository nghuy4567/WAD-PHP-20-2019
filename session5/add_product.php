...
<body id="page-top">
  ...
  <?php 
    if(isset($_POST['add_product'])) {
      ...
      $sql = "INSERT INTO products(name, description, image, price, created, status, product_category_id) VALUES ('$name','$description', '$image', '$price', '$created', '$status', '$product_category_id')";
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Huy R7</span>
                    ...
                    <div class="p-5">
                      ...
                      <form class="user" action="#" method="POST" enctype='multipart/form-data'>
                        <div class="form-group">
                          <input type="text" class="form-control form-control-user" name="product_category_id" placeholder="Product_category_id">
                        </div>
                        <div class="form-group">
